...
interface Transaction {
  ...
  type: 'income' | 'expense';
  date: string;
  category?: Category; // Agora lemos a categoria
}
...
export function Dashboard() {
  ...
  function processChartData(data: Transaction[]) {
    ...
    // Transforma em lista para o gráfico
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div>
        ...
        <p className="text-slate-400">Sua saúde financeira em tempo real.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-900 p-6 rounded-xl border border-slate-800 flex flex-col items-center justify-center min-h-[300px]">
          <h2 className="text-lg font-semibold text-slate-200 mb-4 w-full">Gastos por Categoria</h2>
          {chartData.length > 0 ? (
        ...
        {/* LISTA DE ÚLTIMAS (Layout que você gostou) */}
